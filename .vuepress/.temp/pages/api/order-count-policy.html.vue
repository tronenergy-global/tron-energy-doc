<template><div><p>#Number of purchases</p>
...
<td>int</td>
<td>yes</td>
<td>number of purchases, 5-1000 times</td>
<td>10</td>
</tr>
<tr>
...
<ul>
<li>If the address has insufficient bandwidth/TRX, the platform will automatically transfer 0.345 TRX to ensure the transaction proceeds smoothly.</li>
</ul>
</div>
...
<h1 id="query" tabindex="-1"><a class="header-anchor" href="#query" aria-hidden="true">#</a> Query</h1>
...
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
    ...
    <span class="token property">"results"</span><span class="token operator">:</span> <span class="token punctuation">[</span>
        <span class="token punctuation">{</span>
            ...
            <span class="token property">"last_step_display"</span><span class="token operator">:</span> <span class="token string">"deledate"</span><span class="token punctuation">,</span>
            <span class="token property">"status_display"</span><span class="token operator">:</span> <span class="token string">"enable"</span><span class="token punctuation">,</span>
            <span class="token property">"auto_type"</span><span class="token operator">:</span> <span class="token number">1</span><span class="token punctuation">,</span>                     <span class="token comment">// 1-only energy，2-energy+bandwidth</span>
            <span class="token property">"auto_type_display"</span><span class="token operator">:</span> <span class="token string">"only energy"</span><span class="token punctuation">,</span>
            ...
            <span class="token property">"count_limit"</span><span class="token operator">:</span> <span class="token number">8</span>                    <span class="token comment">// times</span>
        <span class="token punctuation">}</span><span class="token punctuation">,</span>
        ...
    <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
