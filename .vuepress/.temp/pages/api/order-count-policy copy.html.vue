...
<ul>
<li>如果下单时地址需要带宽，则会委托能量的同时检查免费带宽是否足够，如果不足则会额外转0.349TRX到委托账户，会额外扣除ITRX账户0.5余额</li>
</ul>
</div>
...
<li>
<p>异常返回请参考<RouterLink to="/general/error-code.html">API返回值</RouterLink></p>
</li>
<li>
<p>字段解释</p>
</li>
