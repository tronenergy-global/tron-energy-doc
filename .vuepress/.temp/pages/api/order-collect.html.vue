<template><div><h2 id="background" tabindex="-1"><a class="header-anchor" href="#background" aria-hidden="true">#</a> background</h2>
<p>If your scenario is to collect funds from the payment address to the cold/hot wallet, the ordinary energy interface can no longer meet the needs. For this reason, we have rebuilt the collection interface to make it very simple for you to collect.</p>
...
<td>string</td>
<td>No</td>
<td>Delegation success/failure will be notified to this address</td>
...
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
     ...
     <span class="token property">"scene"</span><span class="token operator">:</span> <span class="token number">1</span><span class="token punctuation">,</span>
...
<td>scene</td>
<td>int</td>
<td>Automatic judgment at 0 will return the actual execution scenario</td>
<td></td>
</tr>
<tr>
<td>amount</td>
<td>int</td>
<td>The order cost, in sun, needs to be divided by 1000000 to convert to TRX</td>
<td></td>
</tr>
<tr>
<td>balance</td>
...
<span class="token keyword">func</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  ordered_data <span class="token operator">:=</span> <span class="token keyword">map</span><span class="token punctuation">[</span><span class="token builtin">string</span><span class="token punctuation">]</span><span class="token keyword">interface</span><span class="token punctuation">{</span><span class="token punctuation">}</span><span class="token punctuation">{</span>
    <span class="token string">"scene"</span><span class="token punctuation">:</span>        data<span class="token punctuation">.</span>Scene<span class="token punctuation">,</span>
