<template><div><h1 id="购买笔数" tabindex="-1"><a class="header-anchor" href="#购买笔数" aria-hidden="true">#</a> 购买笔数</h1>
...
<ul>
<li>如果地址的带宽/trx不足，平台将自动转转移0.345trx，保证转账顺利进行</li>
</ul>
</div>
...
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
    ...
    <span class="token property">"results"</span><span class="token operator">:</span> <span class="token punctuation">[</span>
        <span class="token punctuation">{</span>
            ...
            <span class="token property">"last_step_display"</span><span class="token operator">:</span> <span class="token string">"委托中"</span><span class="token punctuation">,</span>
            ...
            <span class="token property">"auto_type"</span><span class="token operator">:</span> <span class="token number">1</span><span class="token punctuation">,</span>                     <span class="token comment">// 1-仅能量，2-能量+带宽</span>
            <span class="token property">"auto_type_display"</span><span class="token operator">:</span> <span class="token string">"仅能量"</span><span class="token punctuation">,</span>
            ...
            <span class="token property">"count_limit"</span><span class="token operator">:</span> <span class="token number">8</span>                    <span class="token comment">// 剩余次数</span>
        <span class="token punctuation">}</span><span class="token punctuation">,</span>
        ...
    <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
