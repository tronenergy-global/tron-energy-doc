...
<p>如果您的场景是收款地址归集资金到到冷/热钱包，普通的能量接口已不能满足需要，为此我们重新构建了归集接口，可以让您在归集时十分简单</p>
...
<td>Tron地址</td>
<td>否</td>
<td>需要转账的地址<br/>某些场景下，您并不是给固定地址转账，有可能接受方无U，需要消耗额外的能量<br/>此参数会自动判断，如果对方无U，会代理额外能量，但是会产生一定的费用</td>
<td></td>
</tr>
<tr>
<td>callback_url</td>
...
<td>scene</td>
<td>int</td>
<td>0时自动判断，会返回实际执行场景</td>
<td></td>
</tr>
<tr>
<td>amount</td>
<td>int</td>
<td>订单花费，单位sun，转成TRX需要除以1000000</td>
<td></td>
</tr>
<tr>
<td>balance</td>
...
<ul>
<li>下单后为了查询订单的完成状态，您可以使用<RouterLink to="/zh/api/order-query.html">主动查询</RouterLink>或者<RouterLink to="/zh/general/callback.html">被动回调</RouterLink></li>
</ul>
</div>
