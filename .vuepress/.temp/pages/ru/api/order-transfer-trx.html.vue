<template><div><h1 id="трансфер-небольших-сумм-trx" tabindex="-1"><a class="header-anchor" href="#трансфер-небольших-сумм-trx" aria-hidden="true">#</a> Трансфер небольших сумм TRX</h1>
<h2 id="адрес-api" tabindex="-1"><a class="header-anchor" href="#адрес-api" aria-hidden="true">#</a> Адрес API</h2>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>POST /api/v1/frontend/order/transfer
...
<td>int</td>
<td>Да</td>
<td>Необходимый TRX, в единицах sun, в диапазоне от 100000 до 10000000<br/>То есть от 0.1 до 10 TRX</td>
<td>345000</td>
</tr>
<tr>
...
<td>Адрес Tron</td>
<td>Да</td>
<td>Адрес должен быть активирован, иначе заказ не выполнится</td>
<td></td>
</tr>
</tbody>
</table>
...
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
    ...
    <span class="token property">"txid"</span><span class="token operator">:</span> <span class="token string">"9df44479551ef93c9bbfeca3cb82ef1564199d2d492ad38f7f1d2e454f5efb0f"</span><span class="token punctuation">,</span>
...
<li>
<p>Для примеров ошибок обратитесь к <RouterLink to="/ru/general/error-code.html">API возвращаемые значения</RouterLink></p>
</li>
<li>
<p>Описание полей</p>
</li>
...
<td>errno</td>
<td>int</td>
<td>Код ошибки, 0 - без ошибок</td>
<td></td>
</tr>
<tr>
<td>message</td>
<td>string</td>
<td>Причина ошибки, доступна если errno &gt; 0</td>
<td></td>
</tr>
<tr>
<td>txid</td>
<td>string</td>
<td>txid в блокчейне</td>
<td></td>
</tr>
<tr>
<td>balance</td>
<td>int</td>
<td>Баланс, в единицах sun, для перевода в TRX нужно разделить на 1000000</td>
<td></td>
</tr>
</tbody>
</table>
...
URL <span class="token operator">=</span> <span class="token string">"https://{domain}/api/v1/frontend/order/transfer"</span>
data <span class="token operator">=</span> <span class="token punctuation">{</span>
   <span class="token string">'amount'</span><span class="token punctuation">:</span> <span class="token number">345000</span><span class="token punctuation">,</span>
   <span class="token string">'receive_address'</span><span class="token punctuation">:</span> <span class="token string">'TExWKszFWYTKZH8LYiovAPKzS3L9MLZ4kw'</span><span class="token punctuation">,</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
...
<span class="token variable">$data</span> <span class="token operator">=</span> <span class="token punctuation">[</span>
    <span class="token string single-quoted-string">'amount'</span> <span class="token operator">=></span> <span class="token number">345000</span><span class="token punctuation">,</span>
...
<span class="token variable">$result</span> <span class="token operator">=</span> <span class="token function">file_get_contents</span><span class="token punctuation">(</span><span class="token string double-quoted-string">"https://{domain}/api/v1/frontend/order/transfer"</span><span class="token punctuation">,</span> <span class="token constant boolean">false</span><span class="token punctuation">,</span> <span class="token variable">$context</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Exception</span> <span class="token punctuation">{</span>
        ...
        data<span class="token punctuation">.</span><span class="token function">put</span><span class="token punctuation">(</span><span class="token string">"amount"</span><span class="token punctuation">,</span> <span class="token number">345000</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        ...
        <span class="token class-name">Request</span> request <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Request<span class="token punctuation">.</span>Builder</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
                <span class="token punctuation">.</span><span class="token function">url</span><span class="token punctuation">(</span><span class="token string">"https://{domain}/api/v1/frontend/order/transfer"</span><span class="token punctuation">)</span>
...
<span class="token keyword">type</span> Data <span class="token keyword">struct</span> <span class="token punctuation">{</span>
	Amount   <span class="token builtin">int</span>    <span class="token string">`json:"amount"`</span>
...
<span class="token keyword">func</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
	...
	data <span class="token operator">:=</span> Data<span class="token punctuation">{</span>
		Amount<span class="token punctuation">:</span>   <span class="token number">345000</span><span class="token punctuation">,</span>
...
<span class="token assign-left variable">URL</span><span class="token operator">=</span><span class="token string">"https://{domain}/api/v1/frontend/order/transfer"</span>
