<template><div><h1 id="покупка-количества-транзакции" tabindex="-1"><a class="header-anchor" href="#покупка-количества-транзакции" aria-hidden="true">#</a> Покупка количества транзакций</h1>
<h2 id="адрес-api" tabindex="-1"><a class="header-anchor" href="#адрес-api" aria-hidden="true">#</a> Адрес API</h2>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>POST /api/v1/frontend/count-delegate-policy
...
<td>int</td>
<td>Да</td>
<td>Количество покупок, 5-1000 раз</td>
<td>10</td>
</tr>
<tr>
...
<td>Tron адрес</td>
<td>Да</td>
<td>Адрес должен быть активирован, иначе заказ не будет выполнен</td>
<td></td>
</tr>
</tbody>
</table>
...
<ul>
<li>Если на адресе недостаточно пропускной способности или TRX, платформа автоматически переведет 0.345 TRX, чтобы обеспечить успешное выполнение транзакции.</li>
</ul>
</div>
...
<td>errno</td>
<td>int</td>
<td>Код ошибки, 0 означает успешное выполнение</td>
<td></td>
</tr>
<tr>
<td>message</td>
<td>string</td>
<td>Причина ошибки, присутствует, если errno &gt; 0</td>
<td></td>
</tr>
<tr>
<td>balance</td>
<td>int</td>
<td>Баланс, единица измерения sun, для перевода в TRX нужно разделить на 1000000</td>
<td></td>
</tr>
</tbody>
</table>
...
URL <span class="token operator">=</span> <span class="token string">"https://{domain}/api/v1/frontend/count-delegate-policy"</span>
data <span class="token operator">=</span> <span class="token punctuation">{</span>
   <span class="token string">'receive_address'</span><span class="token punctuation">:</span> <span class="token string">'TEX5nLeFJ1dyazhJC3P9eYJs7hxgk7knJY'</span><span class="token punctuation">,</span>     <span class="token comment"># 购买次数的地址</span>
   <span class="token string">'times'</span><span class="token punctuation">:</span> <span class="token number">5</span><span class="token punctuation">,</span>      <span class="token comment"># 购买次数</span>
   <span class="token string">'bandwidth'</span><span class="token punctuation">:</span> <span class="token number">0</span><span class="token punctuation">,</span>  <span class="token comment"># 是否同时保证带宽</span>
<span class="token punctuation">}</span>
...
<span class="token variable">$data</span> <span class="token operator">=</span> <span class="token punctuation">[</span>
    <span class="token string single-quoted-string">'bandwidth'</span> <span class="token operator">=></span> <span class="token number">1</span><span class="token punctuation">,</span>
    <span class="token string single-quoted-string">'times'</span> <span class="token operator">=></span> <span class="token number">5</span><span class="token punctuation">,</span>
...
<span class="token variable">$result</span> <span class="token operator">=</span> <span class="token function">file_get_contents</span><span class="token punctuation">(</span><span class="token string double-quoted-string">"https://{domain}/api/v1/frontend/count-delegate-policy"</span><span class="token punctuation">,</span> <span class="token constant boolean">false</span><span class="token punctuation">,</span> <span class="token variable">$context</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Exception</span> <span class="token punctuation">{</span>
        ...
        data<span class="token punctuation">.</span><span class="token function">put</span><span class="token punctuation">(</span><span class="token string">"bandwidth"</span><span class="token punctuation">,</span> <span class="token number">1</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        data<span class="token punctuation">.</span><span class="token function">put</span><span class="token punctuation">(</span><span class="token string">"times"</span><span class="token punctuation">,</span> <span class="token number">5</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        ...
        <span class="token class-name">Request</span> request <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Request<span class="token punctuation">.</span>Builder</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
                <span class="token punctuation">.</span><span class="token function">url</span><span class="token punctuation">(</span><span class="token string">"https://{domain}/api/v1/frontend/count-delegate-policy"</span><span class="token punctuation">)</span>
...
<span class="token keyword">type</span> Data <span class="token keyword">struct</span> <span class="token punctuation">{</span>
	Bandwidth   <span class="token builtin">int</span>    <span class="token string">`json:"bandwidth"`</span>
	Times         <span class="token builtin">int</span> <span class="token string">`json:"times"`</span>
...
<span class="token keyword">func</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
	...
	data <span class="token operator">:=</span> Data<span class="token punctuation">{</span>
		Bandwidth<span class="token punctuation">:</span>   <span class="token number">1</span><span class="token punctuation">,</span>
		Times<span class="token punctuation">:</span>         <span class="token number">5</span><span class="token punctuation">,</span>
  ...
  ordered_data <span class="token operator">:=</span> <span class="token keyword">map</span><span class="token punctuation">[</span><span class="token builtin">string</span><span class="token punctuation">]</span><span class="token keyword">interface</span><span class="token punctuation">{</span><span class="token punctuation">}</span><span class="token punctuation">{</span>
		<span class="token string">"bandwidth"</span><span class="token punctuation">:</span>       data<span class="token punctuation">.</span>Bandwidth<span class="token punctuation">,</span>
		...
		<span class="token string">"times"</span><span class="token punctuation">:</span>           data<span class="token punctuation">.</span>Times<span class="token punctuation">,</span>
	<span class="token punctuation">}</span>
...
<span class="token assign-left variable">URL</span><span class="token operator">=</span><span class="token string">"https://{domain}/api/v1/frontend/count-delegate-policy"</span>
...
<h1 id="запрос" tabindex="-1"><a class="header-anchor" href="#запрос" aria-hidden="true">#</a> Запрос</h1>
<h2 id="адрес-api-1" tabindex="-1"><a class="header-anchor" href="#адрес-api-1" aria-hidden="true">#</a> Адрес API</h2>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>GET /api/v1/frontend/count-delegate-policy?receive_address=
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="параметры-запроса-1" tabindex="-1"><a class="header-anchor" href="#параметры-запроса-1" aria-hidden="true">#</a> Параметры запроса</h2>
<table>
<thead>
<tr>
<th>Название параметра</th>
...
<td>Tron адрес</td>
<td>Нет</td>
<td>Запрос для определенного адреса, если не заполнено, возвращаются все</td>
<td></td>
</tr>
</tbody>
</table>
<h2 id="параметры-ответа-1" tabindex="-1"><a class="header-anchor" href="#параметры-ответа-1" aria-hidden="true">#</a> Параметры ответа</h2>
<ul>
<li>Пример нормального ответа</li>
</ul>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
    ...
    <span class="token property">"results"</span><span class="token operator">:</span> <span class="token punctuation">[</span>
        <span class="token punctuation">{</span>
            ...
            <span class="token property">"receive_address"</span><span class="token operator">:</span> <span class="token string">"TEX5nLeFJ1dyazhJC3P9eYJs7hxgk7knJF"</span><span class="token punctuation">,</span>
            ...
            <span class="token property">"last_step"</span><span class="token operator">:</span> <span class="token number">0</span><span class="token punctuation">,</span>
            <span class="token property">"main_delegated"</span><span class="token operator">:</span> <span class="token boolean">false</span><span class="token punctuation">,</span>
            ...
            <span class="token property">"create_time"</span><span class="token operator">:</span> <span class="token string">"2023-08-23T11:09:27.986610+08:00"</span><span class="token punctuation">,</span>
            <span class="token property">"update_time"</span><span class="token operator">:</span> <span class="token string">"2023-08-23T11:09:27.986660+08:00"</span><span class="token punctuation">,</span>
            <span class="token property">"last_step_display"</span><span class="token operator">:</span> <span class="token string">""</span><span class="token punctuation">,</span>
            <span class="token property">"status_display"</span><span class="token operator">:</span> <span class="token string">""</span><span class="token punctuation">,</span>
            <span class="token property">"auto_type"</span><span class="token operator">:</span> <span class="token number">1</span><span class="token punctuation">,</span>                     <span class="token comment">// </span>
            <span class="token property">"auto_type_display"</span><span class="token operator">:</span> <span class="token string">""</span><span class="token punctuation">,</span>
            <span class="token property">"max_energy"</span><span class="token operator">:</span> <span class="token number">65000</span><span class="token punctuation">,</span>
            <span class="token property">"period"</span><span class="token operator">:</span> <span class="token number">7</span><span class="token punctuation">,</span>
            <span class="token property">"count_limit"</span><span class="token operator">:</span> <span class="token number">8</span>                    <span class="token comment">//</span>
        <span class="token punctuation">}</span><span class="token punctuation">,</span>
        ...
    <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
