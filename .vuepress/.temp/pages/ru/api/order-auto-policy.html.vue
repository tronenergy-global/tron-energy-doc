<template><div><h1 id="интеллектуальная-делегация" tabindex="-1"><a class="header-anchor" href="#интеллектуальная-делегация" aria-hidden="true">#</a> Интеллектуальная делегация</h1>
...
<td>Tron адрес</td>
<td>Да</td>
<td>Адрес должен быть активирован, иначе заказ будет отклонен</td>
<td></td>
</tr>
<tr>
<td>max_energy</td>
<td>int</td>
<td>Нет</td>
<td>Поддерживаемое количество энергии</td>
<td></td>
</tr>
</tbody>
</table>
...
<span class="token front-matter yaml language-yaml"><span class="token key atrule">title</span><span class="token punctuation">:</span> Интеллектуальная делегация</span>
<span class="token punctuation">---</span></span>

<span class="token title important"><span class="token punctuation">#</span> Интеллектуальная делегация</span>


<span class="token title important"><span class="token punctuation">##</span> Адрес API</span>

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>POST /api/v1/frontend/auto-delegate-policy</p>
