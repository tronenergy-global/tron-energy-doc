<template><div><h1 id="оформление-заказа" tabindex="-1"><a class="header-anchor" href="#оформление-заказа" aria-hidden="true">#</a> Оформление заказа</h1>
...
<td>int</td>
<td>Да</td>
<td>Необходимое количество энергии</td>
<td>32000</td>
</tr>
<tr>
<td>period</td>
...
<td>string</td>
<td>Нет</td>
<td>Уведомление будет отправлено на этот адрес в случае успешного выполнения заказа</td>
...
<td>string</td>
<td>Нет</td>
<td>Информация для удобства сопоставления заказов при получении уведомления</td>
<td>S202302320004</td>
</tr>
</tbody>
</table>
...
<td>amount</td>
<td>int</td>
<td>Сумма заказа, единица измерения sun</td>
<td></td>
</tr>
<tr>
<td>balance</td>
...
<ul>
<li>После оформления заказа для проверки статуса выполнения вы можете использовать <RouterLink to="/ru/api/order-query.html">Активный запрос</RouterLink> или <RouterLink to="/ru/general/callback.html">Пассивное уведомление</RouterLink></li>
</ul>
</div>
