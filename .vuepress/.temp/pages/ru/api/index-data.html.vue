<template><div><h1 id="общии-запрос-данных" tabindex="-1"><a class="header-anchor" href="#общии-запрос-данных" aria-hidden="true">#</a> Общий запрос данных</h1>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="параметры-ответа" tabindex="-1"><a class="header-anchor" href="#параметры-ответа" aria-hidden="true">#</a> Параметры ответа</h2>
<ul>
...
<li>
<p>Теоретически, этот интерфейс не возвращает ошибок, при неверном APIKEY возвращает пустые данные.</p>
</li>
<li>
<p>Пояснение полей</p>
</li>
...
<td>int</td>
<td>Доступная энергия платформы</td>
<td></td>
</tr>
<tr>
<td>platform_max_energy</td>
<td>int</td>
<td>Максимальная сумма заказа за одну делегацию,<br/>если заказ нельзя разбить, максимальное количество энергии</td>
<td></td>
</tr>
<tr>
<td>minimum_order_energy</td>
<td>int</td>
<td>Минимальное количество энергии для заказа</td>
<td></td>
</tr>
<tr>
<td>maximum_order_energy</td>
<td>int</td>
<td>Максимальное количество энергии для заказа</td>
<td></td>
</tr>
<tr>
<td>small_amount</td>
<td>int</td>
<td>Заказы меньше этого количества считаются мелкими</td>
<td></td>
</tr>
<tr>
<td>small_addition</td>
<td>float</td>
<td>Комиссия за мелкий заказ, в TRX</td>
<td></td>
</tr>
<tr>
<td>usdt_energy_need_old</td>
<td>int</td>
<td>Рекомендуемая аренда для адресов с U</td>
<td></td>
</tr>
<tr>
<td>usdt_energy_need_new</td>
<td>int</td>
<td>Рекомендуемая аренда для адресов без U</td>
<td></td>
</tr>
<tr>
<td>tiered_pricing</td>
<td>[]</td>
<td>Мои цены, period поддерживает следующие значения:<br/>0 (1 час), 1 (1 день),<br/>3 (3 дня), 30 (30 дней),<br/>price в sun</td>
<td></td>
</tr>
<tr>
<td>balance</td>
<td>int</td>
<td>Мой баланс, в sun</td>
<td></td>
</tr>
</tbody>
</table>
...
URL <span class="token operator">=</span> <span class="token string">"https://{domain}/api/v1/frontend/index-data"</span>
...
<span class="token variable">$URL</span> <span class="token operator">=</span> <span class="token string double-quoted-string">"https://{domain}/api/v1/frontend/index-data"</span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        ...
        <span class="token class-name">String</span> url <span class="token operator">=</span> <span class="token string">"https://{domain}/api/v1/frontend/index-data"</span><span class="token punctuation">;</span>
...
<span class="token assign-left variable">URL</span><span class="token operator">=</span><span class="token string">"https://{domain}/api/v1/frontend/index-data"</span>
